...
description: Implement a markdown plan in an isolated git worktree, validate the result, push the branch, clean up the temporary checkout, and return PR-ready markdown. Use when Codex needs to execute a plan safely without touching the main checkout.
---
